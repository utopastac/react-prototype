      ...
      buttons: {
        buttons: [
          ...
          },
          {
            title: 'Start Dispute',
            type: 'prominent',
            action: { path: '/flows/dispute/transaction', type: BUTTON_ACTION_PATH },
          },
        ]
      }
    }
        ...
        buttons: [
          {
            title: 'Continue',
            type: 'prominent',
            action: { path: '/flows/dispute/reason', type: BUTTON_ACTION_PATH },
          }
        ],
        showHairline: true
      }
        ...
        buttons: [
          {
            title: 'Continue',
            type: 'prominent',
            action: { path: '/flows/dispute/details', type: BUTTON_ACTION_PATH },
          }
        ],
        showHairline: true
      }
        ...
        buttons: [
          {
            title: 'Continue',
            type: 'prominent',
            action: { path: '/flows/dispute/merchant-contact', type: BUTTON_ACTION_PATH },
          }
        ]
      }
    }
        ...
        buttons: [
          {
            title: 'Continue',
            type: 'prominent',
            action: { path: '/flows/dispute/description', type: BUTTON_ACTION_PATH },
          }
        ]
      }
    }
        ...
        buttons: [
          {
            title: 'Continue',
            type: 'prominent',
            action: { path: '/flows/dispute/evidence', type: BUTTON_ACTION_PATH },
          }
        ]
      }
    }
        ...
        buttons: [
          {
            title: 'Skip for Now',
            type: 'standard',
            action: { path: '/flows/dispute/contact', type: BUTTON_ACTION_PATH },
          },
          {
            title: 'Continue',
            type: 'prominent',
        ...
        buttons: [
          {
            title: 'Continue',
            type: 'prominent',
            action: { path: '/flows/dispute/review', type: BUTTON_ACTION_PATH },
          }
        ]
      }
    }
      ...
      buttons: {
        buttons: [
          ...
          },
          {
            ...
            type: 'prominent',
            action: { path: '/flows/dispute/loading', type: BUTTON_ACTION_PATH },
          }
        ]
      }
    }
