...
#### 1. LayoutContext (`src/admin/LayoutContext.tsx`)
...
#### 2. PhonePreview (`src/admin/PhonePreview.tsx`)
...
#### 1. useLayoutData (`src/admin/hooks/useLayoutData.ts`)
...
#### 2. useLayoutHistory (`src/admin/hooks/useLayoutHistory.ts`)
